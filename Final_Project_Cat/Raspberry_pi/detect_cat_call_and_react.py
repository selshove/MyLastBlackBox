...
def play_sound():
    subprocess.run(["aplay", "-D", "plughw:3", "-c2","-r", "48000", "-f", "S16_le","-t", "wav","-V","-stereo","-v","cat.wav"])
    #subprocess.run(["aplay -D plughw:3 -c2 -r 48000 -f S32_LE -t wav -V stereo -v cat_call.wav"])
